...
default_fpc_chip=`getprop ro.vendor.feature.zte_fingerprint_default_fpc`
# ZTE_FINGERPRINT_DEFAULT_SILEAD
default_silead_chip=`getprop ro.vendor.feature.zte_fingerprint_default_silead`
# ZTE_FINGERPRINT_DEFAULT_GOODIX_GF95XX
default_gf95xx_chip=`getprop ro.vendor.feature.zte_fingerprint_default_goodix_gf95xx`
# ZTE_FINGERPRINT_DEFAULT_GOODIX_GF95XX_G3
default_gf95xx_g3_chip=`getprop ro.vendor.feature.zte_fingerprint_default_goodix_gf95xx_g3`
# ZTE_FINGERPRINT_DEFAULT_GOODIX_GF3658
default_gf3658_chip=`getprop ro.vendor.feature.zte_fingerprint_default_goodix_gf3658`
if [ "$default_fpc_chip" = "1" ]; then
    ...
    default_chip="gf95xx"
elif [ "$default_gf95xx_g3_chip" = "1" ]; then
    default_chip="gf95xx"
elif [ "$default_gf3658_chip" = "1" ]; then
    default_chip="gf3658"
else
    default_chip="gf3658"
fi
